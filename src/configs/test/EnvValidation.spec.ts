import { validate } from '../EnvValidation';
...
describe('Environment variables type/definition validation', () => {
    describe.each`
        ...
        ${'should complain when DATABASE_TYPE is neither "postgres" nor "mysql"'}                          | ${true}        | ${'sqlite'}   | ${'localhost'} | ${'5432'}     | ${'jack'}         | ${'jack22'}       | ${'jackDb'}   | ${undefined}    | ${undefined}      | ${'some_encryption_key'} | ${undefined}             | ${undefined}              | ${undefined} | ${undefined}  | ${undefined} | ${undefined} | ${undefined} | ${undefined}    | ${undefined}   | ${undefined}      | ${undefined}                      | ${undefined} | ${undefined}
    `('', (envs) => {
